  ...
  return (
    ...
    <div className="fixed bottom-1 w-full px-2">
      <div className="flex flex-col gap-1 ">
        <div className="flex justify-between items-center p-3 bg-white text-black rounded-[30px]">
        ...
        <div className="flex justify-between items-center p-4 bg-[#2e9569] text-[#020202] rounded-[30px]">
          <div className="flex">
